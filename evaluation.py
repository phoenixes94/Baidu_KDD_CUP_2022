...
def predict(config, train_data):  #, valid_data, test_data):
    ...
    test_x = sorted(glob.glob(os.path.join("data", "sdwpf_baidukddcup2022_test_toy", "test_x", "*")))
    test_y = sorted(glob.glob(os.path.join("data", "sdwpf_baidukddcup2022_test_toy", "test_y", "*")))
